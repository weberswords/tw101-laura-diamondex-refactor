...
public class Main {
    public static void main(String[] args) {
        ...
        library.printBooksContainingPretty("Potter");
        library.printBooksContainingPretty("Sorcerer");
        library.printBooksContainingPretty("Intro");
        library.printBooksContainingPretty("Stone");
    }
}
